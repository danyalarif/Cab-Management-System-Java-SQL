...
public class ViewBookings extends JFrame implements ActionListener{
	...
	public ViewBookings(Person p) {
		...
		button1 = new JButton("Send Booking Request");
		...
		label1 = new JLabel("Active Bookings:");
		...
		lblSelectOrder = new JLabel("Select Booking:");
		...
		bookings = null;
		bookings = Booking.getBookings(p.getID(), p.getType(), false);
		if (customer != null)
		{
		...
		{
			bookings = Booking.searchActiveDriverBookings(bookings, driver.getID());
		}
		String[] temp = null;
		if (bookings.size() == 0)
		{
		...
		contentPane.add(label7, "cell 21 54,aligny center");
		...
		contentPane.add(label8, "cell 26 54");
		...
		contentPane.add(lblTimeCreated, "cell 31 54");
		...
		if (bookings.size() > 0)
		{
			...
			ans3.setText(bookings.get(index).getDriver().getUserName());
			boolean complete = bookings.get(index).getCompleteStatus();
			if (complete)
				ans4.setText("Completed");
			else
				ans4.setText("In Progress");
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		else if (title.equals("Send Booking Request"))
		{
		...
		{
			String details = inp1.getText().toString();
			...
			Booking b = new Booking(customer, details, l1, l2);
			b.saveBooking();
	...
	public void screen2()
	{
		String[] locations = {"Islamabad", "Lahore", "Jhelum", "Rawalpindi", "Multan", "Sargodha", "Karachi", "Larkana", "Abbottabad", "Peshawar"};
		contentPane2 = new JPanel();
		contentPane2.setBackground(new Color(0, 0, 0));
		contentPane2.setBorder(new EmptyBorder(5, 5, 5, 5));
		contentPane2.setVisible(true);
		setContentPane(contentPane2);
		contentPane2.setLayout(new MigLayout("", "[][][][][][][][][][grow][][][grow][][][][][][][][][][][][][][][][][][][][][][][][][][][grow][][][][][][][][][][grow][][][][][][][][][][][][pref!,grow,center][][][][][][][][][][][][][][grow]", "[][][][][][][][][][][][][][][][][][][grow][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][grow][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][]"));
		...
		lblSelectSource = new JLabel("Pickup Location:");
		lblSelectSource.setOpaque(true);
		lblSelectSource.setForeground(Color.WHITE);
		lblSelectSource.setFont(new Font("Times New Roman", Font.PLAIN, 20));
		lblSelectSource.setBackground(Color.RED);
		contentPane2.add(lblSelectSource, "cell 6 27");
		
		comboBox_1 = new JComboBox(locations);
		comboBox_1.setOpaque(true);
		comboBox_1.setFont(new Font("Tahoma", Font.ITALIC, 20));
		comboBox_1.setBackground(new Color(255, 140, 0));
		contentPane2.add(comboBox_1, "cell 9 27,alignx center,aligny center");
		
		lblDestination = new JLabel("Destination:");
		lblDestination.setOpaque(true);
		lblDestination.setForeground(Color.WHITE);
		lblDestination.setFont(new Font("Times New Roman", Font.PLAIN, 20));
		lblDestination.setBackground(Color.RED);
		contentPane2.add(lblDestination, "cell 6 34");
		
		comboBox_2 = new JComboBox(locations);
		comboBox_2.setOpaque(true);
		comboBox_2.setFont(new Font("Tahoma", Font.ITALIC, 20));
		comboBox_2.setBackground(new Color(255, 140, 0));
		contentPane2.add(comboBox_2, "cell 9 34,alignx center,aligny center");
		contentPane2.add(button2, "cell 7 42,aligny center");
	}
